...
const publicFormController = require('@/controllers/coreControllers/publicFormController');

router.route('/forms/:slug').get(publicFormController.getForm);
router.route('/forms/:slug/submit').post(publicFormController.submit);
