...
<div class="space-y-8" style="--ascend-accent: <?php echo e($accent); ?>;">
                                ...
                                <tr class="transition hover:bg-slate-50/50 dark:hover:bg-slate-800/40">
                                    ...
                                    <td class="px-4 py-3.5 text-right space-x-2">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($inv->status !== 'paid'): ?>
                                            ...
                                            <button type="button" wire:click="sendInvoiceWhatsApp(<?php echo e($inv->id); ?>)" class="inline-flex items-center gap-1 font-bold text-emerald-600 hover:underline text-xs" title="Dispatch PDF via WhatsApp">
                                                <i class="fa-brands fa-whatsapp text-emerald-500"></i>WhatsApp PDF
                                            </button>
                                            <button type="button" wire:click="sendInvoiceEmail(<?php echo e($inv->id); ?>)" class="inline-flex items-center gap-1 font-bold text-blue-600 hover:underline text-xs" title="Dispatch PDF via Email">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($moduleKey === 'sales'): ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeTab === 'solar_calculator'): ?>
            <!-- SOLAR CAPACITY & BATTERY SIZING CALCULATOR ENGINE -->
            <?php $calcRes = $this->calculateSolarRequirement(); ?>
            <div class="space-y-6">
                ...
                <section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b pb-4 dark:border-slate-800 mb-6">
                        <div>
                            ...
                            <h2 class="mt-2 text-lg font-bold text-slate-950 dark:text-white"><?php echo e(__('Interactive Solar Inverter & Battery Capacity Calculator')); ?></h2>
                            <p class="text-sm text-slate-500"><?php echo e(__('Select household or commercial appliances to instantly compute peak load (Watts), daily energy requirement (kWh), and get auto-recommended Ascend inverter & battery packages.')); ?></p>
                        </div>
                    </div>
                        ...
                        <div class="rounded-2xl border border-emerald-500/30 bg-emerald-50/50 p-6 dark:border-emerald-800 dark:bg-emerald-950/20 flex flex-col justify-between space-y-6">
                            <div>
                                ...
                                <div class="mt-4 grid grid-cols-2 gap-4 border-b pb-4 dark:border-emerald-800/40">
                                    <div>
                                        ...
                                        <p class="text-2xl font-black text-slate-900 dark:text-white"><?php echo e(number_format($calcRes['total_wattage'])); ?> Watts</p>
                                    </div>
                                    <div>
                                        <p class="text-xs font-bold text-slate-400 uppercase">Daily Energy Needed</p>
                                        <p class="text-2xl font-black text-emerald-600"><?php echo e(number_format($calcRes['daily_kwh'], 1)); ?> kWh</p>
                                    </div>
                                </div>
                                ...
                                <div class="mt-4 space-y-3">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p class="text-xs font-bold text-slate-900 dark:text-white"><?php echo e($calcRes['recommended_inverter']); ?></p>
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p class="text-xs font-bold text-slate-900 dark:text-white"><?php echo e($calcRes['recommended_battery']); ?></p>
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p class="text-xs font-bold text-slate-900 dark:text-white"><?php echo e($calcRes['recommended_panels']); ?></p>
                            ...
                            <div class="pt-4 border-t dark:border-emerald-800/40 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                                <div>
                                    ...
                                    <p class="text-2xl font-black text-slate-900 dark:text-white">₦<?php echo e(number_format($calcRes['estimated_total_ngn'], 2)); ?></p>
                                </div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($moduleKey === 'marketing'): ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeTab === 'web_lead_capture'): ?>
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b pb-6 dark:border-slate-800">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <h2 class="mt-1 text-xl font-black text-slate-950 dark:text-white"><?php echo e(__('Ascend Systems Official Web Lead Generation & Quote Form')); ?></h2>
                                <p class="text-xs text-slate-500"><?php echo e(__('Captures solar energy inquiries directly from www.ascendsystems.ng, auto-creates CRM leads, and dispatches instant quotes.')); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-6 grid gap-6 lg:grid-cols-2">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="space-y-3 max-h-[380px] overflow-y-auto">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $dbWebLeads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lead): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <div class="rounded-xl border border-slate-200 p-4 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-xs flex items-center justify-between">
                                        <div>
                                            <div class="flex items-center gap-2">
                                                <span class="font-bold text-xs text-slate-900 dark:text-white"><?php echo e($lead->client_name); ?></span>
                                                <span class="rounded-full bg-purple-500/10 px-2 py-0.5 text-[10px] font-bold text-purple-600"><?php echo e($lead->city_location); ?></span>
                                            </div>
                                            <p class="mt-1 text-[11px] text-purple-600 font-semibold"><?php echo e($lead->system_interest); ?></p>
                                            <p class="text-[10px] text-slate-400"><?php echo e($lead->phone); ?> · <?php echo e($lead->email); ?></p>
                                        </div>
                                        <div class="text-right">
                                            ...
                                            <p class="mt-1 text-xs font-black text-slate-900 dark:text-white">₦<?php echo e(number_format($lead->estimated_budget_ngn, 2)); ?></p>
                                        </div>
                                    </div>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
        ...
        <?php elseif($activeTab === 'video_script_ai'): ?>
                ...
                <section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b pb-4 dark:border-slate-800 mb-6">
                        <div>
                            ...
                            <h2 class="mt-2 text-lg font-bold text-slate-950 dark:text-white"><?php echo e(__('AI TikTok & Instagram Reels Video Script Studio')); ?></h2>
                            <p class="text-sm text-slate-500"><?php echo e(__('Generate high-converting 30-second video scripts with visual cues, voiceovers, and call-to-actions for Ascend solar equipment.')); ?></p>
                        </div>
                    </div>
                        ...
                        <div class="rounded-2xl border border-slate-200 p-5 dark:border-slate-800 bg-white dark:bg-slate-900 flex flex-col justify-between">
                            <div>
                                ...
                                <div class="mt-4 text-xs leading-relaxed text-slate-700 dark:text-slate-300 font-mono whitespace-pre-wrap max-h-[300px] overflow-y-auto">
                                    <?php echo e($generatedVideoScript ?: "Click 'Generate 30-Sec Video Script' to create your first short-form video script for TikTok & Instagram Reels!"); ?>
        ...
        <?php elseif($activeTab === 'whatsapp_blasts'): ?>
                ...
                <section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b pb-4 dark:border-slate-800 mb-6">
                        <div>
                            ...
                            <h2 class="mt-2 text-lg font-bold text-slate-950 dark:text-white"><?php echo e(__('Automated WhatsApp Product Catalog & Price Sheet Broadcast Engine')); ?></h2>
                            <p class="text-sm text-slate-500"><?php echo e(__('Dispatch high-converting WhatsApp product catalogs with wholesale price sheets directly to B2B distributor contacts.')); ?></p>
                        </div>
                    </div>
        ...
        <?php elseif($activeTab === 'influencers'): ?>
                ...
                <section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b pb-4 dark:border-slate-800 mb-6">
                        <div>
                            ...
                            <h2 class="mt-2 text-lg font-bold text-slate-950 dark:text-white"><?php echo e(__('Brand Ambassador Referral Tracker & Commission Ledger')); ?></h2>
                            <p class="text-sm text-slate-500"><?php echo e(__('Track custom ambassador referral links, lead conversions, attributed sales revenue, and 3% commission payouts.')); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-left text-sm">
                            ...
                            <tbody class="divide-y divide-slate-100 dark:divide-slate-800">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $dbInfluencers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <tr class="transition hover:bg-slate-50/50 dark:hover:bg-slate-800/40">
                                        <td class="px-4 py-3.5 font-bold text-slate-900 dark:text-white">
                                            <p><?php echo e($inf->name); ?></p>
                                            <p class="text-xs text-amber-500 font-normal"><?php echo e($inf->handle); ?> (<?php echo e($inf->platform); ?>)</p>
                                        </td>
                                        <td class="px-4 py-3.5 font-mono text-xs text-purple-600 font-bold">
                                            www.ascendsystems.ng?ref=<?php echo e($inf->referral_code); ?>

                                        </td>
                                        <td class="px-4 py-3.5 font-bold text-slate-900 dark:text-white"><?php echo e($inf->leads_count); ?> Leads</td>
                                        <td class="px-4 py-3.5 font-black text-emerald-600">₦<?php echo e(number_format($inf->sales_attributed_ngn, 2)); ?></td>
                                        <td class="px-4 py-3.5 font-black text-purple-600">₦<?php echo e(number_format($inf->commission_earned_ngn, 2)); ?></td>
                                    </tr>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                    <tr>
        ...
        <?php elseif($activeTab === 'competitor_watch'): ?>
                ...
                <section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                    <div class="flex items-center justify-between border-b pb-4 dark:border-slate-800 mb-6">
                        <div>
                            ...
                            <h2 class="mt-2 text-lg font-bold text-slate-950 dark:text-white"><?php echo e(__('Competitor Solar Ad Intelligence & Market Benchmarking')); ?></h2>
                            <p class="text-sm text-slate-500"><?php echo e(__('Benchmark Ascend Systems pricing & ad engagement against competing solar distributors in Nigeria.')); ?></p>
                        </div>
                    </div>
