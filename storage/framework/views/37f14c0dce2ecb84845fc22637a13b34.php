...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '0b51bfe2fc1d77e49da71d18651b1f92::ui.field','data' => ['label' => $label,'help' => $help,'error' => $error]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($label),'help' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($help),'error' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($error)]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>

    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($description): ?>
        <p class="text-sm" style="color: var(--theme-muted-text-color);"><?php echo e($description); ?></p>
    ...
    <div
        ...
        wire:ignore
        x-data="{
            open: <?php echo \Illuminate\Support\Js::from((bool) $initiallyOpen)->toHtml() ?>,
            query: '',
            options: <?php echo \Illuminate\Support\Js::from($normalizedOptions)->toHtml() ?>,
            selected: <?php echo \Illuminate\Support\Js::from($normalizedSelected)->toHtml() ?>,
            multiple: <?php echo \Illuminate\Support\Js::from((bool) $multiple)->toHtml() ?>,
            maxSelections: <?php echo \Illuminate\Support\Js::from($maxSelections !== null ? (int) $maxSelections : null)->toHtml() ?>,
            live: <?php echo \Illuminate\Support\Js::from((bool) $live)->toHtml() ?>,
            syncOnClose: <?php echo \Illuminate\Support\Js::from((bool) $syncOnClose)->toHtml() ?>,
            pendingSync: false,
            activeProvider: 'all',
            groupMenuOpen: false,
            allowedProviders: <?php echo \Illuminate\Support\Js::from($normalizedAllowedProviders)->toHtml() ?>,
            networkOptions: <?php echo \Illuminate\Support\Js::from($normalizedNetworkOptions)->toHtml() ?>,
            groupOptions: <?php echo \Illuminate\Support\Js::from($normalizedGroupOptions)->toHtml() ?>,
            showNetworkFilters: <?php echo \Illuminate\Support\Js::from((bool) $showNetworkFilters)->toHtml() ?>,
            wireModel: <?php echo \Illuminate\Support\Js::from($wireModel)->toHtml() ?>,
                ...
                <div class="flex min-w-0 flex-1 flex-wrap gap-2 cursor-pointer" x-on:click="togglePanel()">
                    ...
                    <template x-if="!selectedOptions.length">
                        <div class="flex min-h-[2.75rem] min-w-0 flex-1 items-center gap-3 rounded-[0.9rem] px-1 pr-2">
                            ...
                            <span class="min-w-0">
                                <span class="block truncate text-sm font-semibold" style="color: var(--theme-header-text-color);"><?php echo e($placeholder ?: __('Choose channel accounts')); ?></span>
                                <span class="block truncate text-xs" style="color: var(--theme-muted-text-color);"><?php echo e(__('Pick one or more connected profiles for this workflow.')); ?></span>
                            </span>
                        </div>
                    </template>
                </div>
                ...
                <div class="border-b px-4 py-3" style="border-color: rgba(var(--theme-border-color-rgb), 0.68);">
                    <div class="flex flex-nowrap items-center gap-3 rounded-[0.9rem] border px-3 py-2.5" style="border-color: rgba(var(--theme-border-color-rgb), 0.68); background-color: rgba(var(--theme-surface-base-rgb,255,255,255),0.98);">
                        ...
                        <div x-show="multiple" x-cloak class="ml-auto flex shrink-0 items-center gap-2 whitespace-nowrap">
                            <span class="shrink-0 rounded-full px-3 py-1.5 text-sm font-medium" style="background-color: rgba(var(--theme-accent-rgb), 0.10); color: var(--theme-accent);" x-text="`${selectedCount()} <?php echo e(__('selected')); ?>`"></span>
                            ...
                            <button
                                ...
                                x-bind:title="allOptionsSelected() ? '<?php echo e(__('Unselect all')); ?>' : '<?php echo e(__('Select all')); ?>'"
                            >
                                <span
                    ...
                    <template x-if="showNetworkFilters && visibleProviders.length > 1">
                        <div class="mt-3 flex flex-wrap gap-2">
                            ...
                            >
                                <span><?php echo e(__('All networks')); ?></span>
                            </button>
                ...
                <div class="max-h-80 overflow-y-auto">
                    ...
                    <template x-if="!filteredOptions.length">
                        <div class="px-4 py-10 text-center text-sm" style="color: var(--theme-muted-text-color);">
                            <?php echo e($emptyLabel ?: __('No matching channels found.')); ?>

                        </div>
                    </template>
                </div>

                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($connectHref): ?>
                    <div class="border-t px-4 py-4" style="border-color: rgba(var(--theme-border-color-rgb), 0.68);">
                        <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '0b51bfe2fc1d77e49da71d18651b1f92::ui.button','data' => ['href' => $connectHref,'block' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($connectHref),'block' => true]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>

                            <i class="fa-light fa-plus"></i>
                            <?php echo e($connectLabel ?: __('Connect a channel')); ?>
...
<?php endif; ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($name && $multiple): ?>
            <template x-for="selectedKey in selectedKeys()" :key="'input-'+selectedKey">
                <input type="hidden" name="<?php echo e($name); ?>[]" x-bind:value="selectedKey">
            </template>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($name && ! $multiple): ?>
            <input type="hidden" name="<?php echo e($name); ?>" x-bind:value="selectedKeys()[0] ?? ''">
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! $multiple): ?>
            <input
                ...
                <?php if($wireModel && ! $live): ?> wire:model.defer="<?php echo e($wireModel); ?>" <?php endif; ?>
            >
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
 <?php echo $__env->renderComponent(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\DELL\Downloads\Ascend AI\resources\themes/app/default/resources/views/components/ui/channel-selector.blade.php ENDPATH**/ ?>