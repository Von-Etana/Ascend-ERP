...
<?php
    ...
    $steps = [
        ...
        [
            ...
            'url' => route('portal.ai-studio.settings'),
        ...
        [
            ...
            'completed' => $hasPosts,
            'url' => route('portal.publishing.calendar'),
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($percent < 100): ?>
    <div
        ...
        <div class="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div class="space-y-2 max-w-xl">
                ...
                <p class="text-sm text-indigo-200/80 leading-relaxed">
                    Complete these <?php echo e($totalSteps); ?> essential steps to unlock full automated social publishing, omnichannel inbox handling, and AI agent execution.
                </p>
                
                <!-- Progress Bar -->
                <div class="pt-2">
                    <div class="flex items-center justify-between text-xs font-medium text-indigo-200 mb-1.5">
                        <span>Progress (<?php echo e($completedCount); ?>/<?php echo e($totalSteps); ?> completed)</span>
                        <span class="font-bold text-white"><?php echo e($percent); ?>%</span>
                    </div>
        ...
        <div class="mt-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-4 pt-4 border-t border-indigo-800/40">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <a
                    ...
                    class="group relative flex items-start gap-3 rounded-xl border p-3.5 transition-all <?php echo e($step['completed'] ? 'border-emerald-500/40 bg-emerald-950/20 text-emerald-100' : 'border-indigo-800/50 bg-indigo-950/40 text-indigo-100 hover:border-indigo-500/60 hover:bg-indigo-900/40'); ?>"
                >
                    <div class="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg <?php echo e($step['completed'] ? 'bg-emerald-500/20 text-emerald-400' : 'bg-indigo-800/50 text-indigo-300 group-hover:bg-indigo-700/60 group-hover:text-white'); ?>">
                    ...
                    <div class="min-w-0">
                        <div class="flex items-center gap-1.5 font-semibold text-xs text-white">
                            <span class="truncate"><?php echo e($step['title']); ?></span>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($step['completed']): ?>
                                <span class="rounded bg-emerald-500/20 px-1.5 py-0.2 text-[10px] font-medium text-emerald-300">Done</span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                        <p class="mt-0.5 text-[11px] text-indigo-200/70 line-clamp-1"><?php echo e($step['description']); ?></p>
                    </div>
                </a>
...
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<?php /**PATH C:\Users\DELL\Downloads\Ascend AI\resources\themes/app/default/resources/views/components/ui/onboarding-wizard.blade.php ENDPATH**/ ?>