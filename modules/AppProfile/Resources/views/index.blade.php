@php
    ...
    $hasBillingAccess = saas_features_enabled() && $user->hasActivePlan();
@endphp
                            ...
                            <div class="grid gap-5 md:grid-cols-2">
                                <div class="md:col-span-2">
                                    <x-ui.input
                                        ...
                                        :help="$canChangeEmail
                                            ? __('Workspace notifications and account notices are sent here.')
            ...
            <div class="space-y-5">
                ...
                <x-ui.card class="space-y-5">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="rounded-[1rem] border p-4" style="border-color: var(--theme-border-color); background: var(--theme-surface-soft);">
                            <p class="text-[11px] font-semibold uppercase tracking-[0.18em]" style="color: var(--theme-muted-text-color);">{{ __('Workspace access') }}</p>
                            <p class="mt-2 text-sm font-medium" style="color: var(--theme-header-text-color);">{{ saas_features_enabled() ? ($user->plan?->name ?: __('No plan assigned')) : __('Internal workspace') }}</p>
                        </div>
                ...
                <x-ui.card class="space-y-3">
                    ...
                    <p class="text-sm leading-7" style="color: var(--theme-muted-text-color);">
                        {{ __('Use the same email you expect to receive workspace notifications on, and keep your locale aligned with the language you want the portal to default to after sign in.') }}
                    </p>
                </x-ui.card>
            </div>
        </section>
