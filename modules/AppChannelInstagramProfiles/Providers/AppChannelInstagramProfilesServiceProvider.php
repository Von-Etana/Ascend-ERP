...
use Modules\AppChannelInstagramProfiles\Facades\Instagram;
...
use Modules\AppChannelInstagramProfiles\Support\InstagramProfilesChannelDriver;
...
class AppChannelInstagramProfilesServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        if (! class_exists('Instagram')) {
            class_alias(Instagram::class, 'Instagram');
        }
    }
    ...
    public function boot(): void
    {
        ...
        register_channel_module('instagram_profile', [
            ...
            'capability' => [
                ...
                'driver' => InstagramProfilesChannelDriver::class,
                'module' => [
                    'name' => 'AppChannelInstagramProfiles',
                    'source' => 'module',
                ],
