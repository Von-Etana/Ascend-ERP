...
use Modules\AppChannelFacebookPages\Facades\Facebook;
...
use Modules\AppChannelFacebookPages\Support\FacebookPagesChannelDriver;
...
class AppChannelFacebookPagesServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        if (! class_exists('Facebook')) {
            class_alias(Facebook::class, 'Facebook');
        }
    }
    ...
    public function boot(): void
    {
        ...
        register_channel_module('facebook_page', [
            ...
            'capability' => [
                ...
                'connect_label' => 'Page',
                'driver' => FacebookPagesChannelDriver::class,
                'module' => [
                    'name' => 'AppChannelFacebookPages',
                    'source' => 'module',
                ],
