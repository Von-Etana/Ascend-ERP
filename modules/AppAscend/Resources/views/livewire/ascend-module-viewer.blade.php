                            ...
                            <tbody class="divide-y divide-slate-100 dark:divide-slate-800">
                                ...
                                @forelse ($myOrders as $ord)
                                    <tr class="transition hover:bg-slate-50/50 dark:hover:bg-slate-800/40">
                                        ...
                                        <td class="px-4 py-3.5 text-right">
                                            @if ($ord->invoice_id)
                                                <a href="{{ route('portal.invoice.pdf', ['invoice' => $ord->invoice_id]) }}" class="inline-flex items-center gap-1.5 rounded-lg bg-emerald-500/10 px-3 py-1.5 text-xs font-bold text-emerald-600 hover:bg-emerald-500/20">
