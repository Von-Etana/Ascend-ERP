...
{
    public function dispatchGeneric(string $event, ?int $userId, ?int $teamId, array $payload = []): void
    {
        if (! $userId) {
            return;
        }
        ...
        foreach ($webhooks as $webhook) {
            ...
            $this->deliver($webhook, $event, $payload, $teamId);
        }
    }
    ...
    protected function deliver(AutomationWebhook $webhook, string $event, array $payload, ?int $teamId = null): void
    {
        ...
        try {
            ...
            AutomationLog::query()->create([
                ...
                'team_id' => $teamId ?? $webhook->team_id,
                'api_key_id' => null,
