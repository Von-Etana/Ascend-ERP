        ...
        <div class="stepper">
            <div class="step-card {{ $currentStep === 'requirements' ? 'active' : '' }} {{ in_array($currentStep, ['setup', 'finish'], true) ? 'done' : '' }}">
                ...
                <div class="step-copy">
                    ...
                    <span>Check PHP, server software, extensions, and writable paths.</span>
                </div>
            </div>
        ...
        @if ($currentStep === 'setup')
            <section class="panel">
                <div class="panel-header">
                    ...
                    <p class="panel-subtitle">Provide workspace, database, and administrator information to complete installation.</p>
                </div>
                ...
                <form method="POST" action="{{ route('installer.store', ['step' => 'setup']) }}">
                    ...
                    <div class="section">
                        ...
                        <div class="fields">
                            <div class="field full">
                                <label for="website_title">Workspace name *</label>
                                <input id="website_title" name="website_title" type="text" value="{{ $formData['website_title'] ?? 'Ascend Systems' }}" placeholder="Ascend Systems" class="{{ $errorBag->has('website_title') ? 'input-error' : '' }}">
                                @if ($errorBag->has('website_title')) <div class="field-error">{{ $errorBag->first('website_title') }}</div> @endif
                            </div>
                            <div class="field full">
                                <label for="website_description">Workspace description</label>
                                <textarea id="website_description" name="website_description" placeholder="Short internal description used for metadata" class="{{ $errorBag->has('website_description') ? 'input-error' : '' }}">{{ $formData['website_description'] ?? '' }}</textarea>
                    ...
                    <div class="actions">
                        <div class="actions-note">
                            <div class="status-line">The installer will update the environment file, run migrations, save workspace metadata, and create the first super administrator. No license key is required for Ascend Systems internal workspace installs.</div>
                        </div>
        ...
        @if ($currentStep === 'finish')
            <section class="panel finish-card">
                ...
                <div>
                    ...
                    <p class="finish-copy">The application is ready. Environment variables were saved, the database was migrated, workspace metadata was stored, and the administrator account was created successfully.</p>
                </div>
