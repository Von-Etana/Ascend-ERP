...
return new class extends Migration
{
    public function up(): void
    {
        ...
        try {
            ...
            if (! Schema::hasTable('account_group_social_account')) {
            ...
            if (! Schema::hasTable('affiliate_profiles')) {
            ...
            if (! Schema::hasTable('ai_content_plans')) {
            ...
            if (! Schema::hasTable('ai_image_jobs')) {
            ...
            if (! Schema::hasTable('ai_publishing_prompts')) {
            ...
            if (! Schema::hasTable('ai_publishing_runs')) {
            ...
            if (! Schema::hasTable('ai_studio_user_settings')) {
            ...
            if (! Schema::hasTable('ai_studio_workspace_settings')) {
            ...
            if (! Schema::hasTable('ai_video_jobs')) {
            ...
            if (! Schema::hasTable('automation_api_keys')) {
            ...
            if (! Schema::hasTable('automation_webhooks')) {
            ...
            if (! Schema::hasTable('blog_tag_maps')) {
            ...
            if (! Schema::hasTable('bulk_post_batches')) {
            ...
            if (! Schema::hasTable('bulk_post_rows')) {
            ...
            if (! Schema::hasTable('credit_topup_ledgers')) {
            ...
            if (! Schema::hasTable('credit_usage_logs')) {
            ...
            if (! Schema::hasTable('notification_manual')) {
            ...
            if (! Schema::hasTable('notification_manual_states')) {
            ...
            if (! Schema::hasTable('payment_manual')) {
            ...
            if (! Schema::hasTable('payment_subscriptions')) {
            ...
            if (! Schema::hasTable('publishing_campaigns')) {
            ...
            if (! Schema::hasTable('publishing_captions')) {
            ...
            if (! Schema::hasTable('publishing_labels')) {
            ...
            if (! Schema::hasTable('publishing_watermarks')) {
            ...
            if (! Schema::hasTable('publishing_watermark_social_account')) {
            ...
            if (! Schema::hasTable('rss_schedules')) {
            ...
            if (! Schema::hasTable('rss_schedule_histories')) {
            ...
            if (! Schema::hasTable('team_post_comments')) {
            ...
            if (! Schema::hasTable('team_post_reviews')) {
