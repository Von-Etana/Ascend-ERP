...
@php
    ...
    $internalWorkspaceMode = app_internal_workspace_mode();
    ...
    if (! $internalWorkspaceMode) {
        $footerExplore = array_merge($footerExplore, [
            ...
            >
                <div class="flex items-center justify-between gap-4 lg:gap-6">
                    ...
                    <div class="hidden items-center gap-2.5 lg:flex">
                        ...
                        @else
                            <a href="{{ route('login') }}" class="guest-marketing-action-button inline-flex h-11 items-center rounded-full border border-white/10 bg-white/[0.03] px-5 text-sm font-medium text-white/72 transition hover:bg-white/8 hover:text-white">{{ __('Sign in') }}</a>
                            @if ($signupEnabled && ! $internalWorkspaceMode)
                ...
                <div x-cloak x-show="open" x-transition class="mt-4 space-y-4 border-t border-white/8 pt-4 lg:hidden">
                    ...
                    <div class="grid gap-2 sm:grid-cols-2">
                        ...
                        @else
                            <a href="{{ route('login') }}" class="inline-flex items-center justify-center rounded-2xl border border-white/10 px-4 py-3 text-sm font-medium text-white/80">{{ __('Sign in') }}</a>
                            @if ($signupEnabled && ! $internalWorkspaceMode)
                ...
                <div class="grid gap-10 px-6 py-8 lg:grid-cols-[1.2fr_1.5fr_0.7fr] lg:px-8 lg:py-10">
                    ...
                    <div class="grid gap-8 sm:grid-cols-3">
                        ...
                        <div>
                            ...
                            <div class="mt-4 grid gap-3 text-sm text-white/66">
                                ...
                                @else
                                    <a href="{{ route('login') }}" class="no-theme-link transition hover:text-white" style="color: inherit;">{{ __('Workspace access') }}</a>
                                @endunless
                            </div>
                        </div>
                    ...
                    <div class="lg:justify-self-end">
                        ...
                        <div class="mt-4 flex flex-col gap-3">
                            ...
                            @endif
                            @if ($contactEmail === '' && $contactPhone === '' && ! $internalWorkspaceMode)
