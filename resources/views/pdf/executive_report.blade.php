...
<head>
    ...
    <style>
        * { font-family: 'DejaVu Sans', sans-serif !important; }
        body { font-family: 'DejaVu Sans', sans-serif !important; color: #1e293b; font-size: 11px; line-height: 1.5; margin: 0; padding: 25px; }
...
<body>
    ...
    <div style="width: 100%; margin-top: 20px;">
        <div class="sign-box">
            ...
            <strong style="color: #0f172a;">Managing Director & CEO — Ascend Systems</strong>
        </div>
    ...
    <!-- Official Footer -->
    <div class="footer">
        <strong>Ascend Systems</strong> — Enterprise Resource Planning (ERP) Platform<br>
