...
<body>
        ...
        <table class="details-table">
            <tr>
                ...
                <td style="width: 45%; text-align: right;">
                    <div class="customer-detail"><strong>Quote Date:</strong> {{ isset($quote['created_at']) ? date('F d, Y', strtotime($quote['created_at'])) : date('F d, Y') }}</div>
                    <div class="customer-detail"><strong>Valid Until:</strong> {{ isset($quote['valid_until']) ? date('F d, Y', strtotime($quote['valid_until'])) : date('F d, Y', strtotime('+14 days')) }}</div>
    ...
    <div style="margin-top: 15px;">
        <div class="terms-box">
            <div style="font-weight: bold; color: #0f172a; text-transform: uppercase; margin-bottom: 4px;">Terms & Notes:</div>
            <div style="white-space: pre-wrap; line-height: 1.4;">{{ $quote['notes'] ?? "• Quote valid for 14 calendar days from date of issue.\n• Turnkey delivery, setup, and commissioning included." }}</div>
        </div>
